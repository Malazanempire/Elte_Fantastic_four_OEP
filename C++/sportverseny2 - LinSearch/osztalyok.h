...
{
protected:
    eredmeny func(const adat& e) const override {return eredmeny(e.helyezes<7? 1 : 0,1);}
...
class LinKer : public LinSearch<sor>
{
protected:
    bool cond(const sor& e) const override {return e.indult>=3 && e.erem==e.indult;}
